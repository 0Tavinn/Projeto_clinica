...
# Garante que o pacote `app` seja importável quando alembic é rodado a
...
# A URL real vem das Settings da aplicação (variáveis de ambiente), nunca do
# alembic.ini — evita duas fontes de verdade divergentes para credenciais.
